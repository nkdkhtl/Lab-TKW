...
namespace BTH_04_DF.Controllers
{
    public class LearnersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LearnerId,LastName,LastMidName,EnrollmentDate,MajorId")] Learner learner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("LearnerId,LastName,LastMidName,EnrollmentDate,MajorId")] Learner learner)
        {
            ModelState.Remove("Major");
