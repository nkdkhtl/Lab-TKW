    ...
    public partial class V1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__KHACH_HA__3214EC27EEF8F9C5", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__LOAI_SAN__3214EC27196977B6", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__QUAN_TRI__3214EC275C979655", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__HOA_DON__3214EC27F8C60504", x => x.ID);
                    table.ForeignKey(
                        name: "FK__HOA_DON__MaKhaHa__46E78A0C",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__SAN_PHAM__3214EC2712DB1977", x => x.ID);
                    table.ForeignKey(
                        name: "FK__SAN_PHAM__MaLoai__3E52440B",
                        column: x => x.MaLoai,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__CT_HOA_D__3214EC2758AFDE44", x => x.ID);
                    table.ForeignKey(
                        name: "FK__CT_HOA_DO__HoaDo__49C3F6B7",
                        column: x => x.HoaDonID,
                        principalTable: "HOA_DON",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK__CT_HOA_DO__SanPh__4AB81AF0",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__HOA_DON__835ED13A6AEE3602",
                table: "HOA_DON",
                column: "MaHoaDon",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__KHACH_HA__1F031876E1E59CDA",
                table: "KHACH_HANG",
                column: "DienThoai",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__KHACH_HA__88D2F0E443A41E1C",
                table: "KHACH_HANG",
                column: "MaKhachHang",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__KHACH_HA__A9D105349FABD8B2",
                table: "KHACH_HANG",
                column: "Email",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__LOAI_SAN__730A57580C6DF2F3",
                table: "LOAI_SAN_PHAM",
                column: "MaLoai",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__QUAN_TRI__D5B8C7F072BDFA2F",
                table: "QUAN_TRI",
                column: "TaiKhoan",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__SAN_PHAM__FAC7442CDCBBCE3C",
                table: "SAN_PHAM",
                column: "MaSanPham",
                unique: true,
