...
public partial class K64cnt2dbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            // Leave empty so Program.cs (DI) provides the connection.
            // Optionally: read from environment if you want a fallback.
        }
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__CT_HOA_D__3214EC2758AFDE44");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HOA_DON__3214EC27F8C60504");

            entity.ToTable("HOA_DON");

            entity.HasIndex(e => e.MaHoaDon, "UQ__HOA_DON__835ED13A6AEE3602").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__KHACH_HA__3214EC27EEF8F9C5");

            entity.ToTable("KHACH_HANG");

            entity.HasIndex(e => e.DienThoai, "UQ__KHACH_HA__1F031876E1E59CDA").IsUnique();

            entity.HasIndex(e => e.MaKhachHang, "UQ__KHACH_HA__88D2F0E443A41E1C").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__KHACH_HA__A9D105349FABD8B2").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__LOAI_SAN__3214EC27196977B6");

            entity.ToTable("LOAI_SAN_PHAM");

            entity.HasIndex(e => e.MaLoai, "UQ__LOAI_SAN__730A57580C6DF2F3").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__QUAN_TRI__3214EC275C979655");

            entity.ToTable("QUAN_TRI");

            entity.HasIndex(e => e.TaiKhoan, "UQ__QUAN_TRI__D5B8C7F072BDFA2F").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SAN_PHAM__3214EC2712DB1977");

            entity.ToTable("SAN_PHAM");

            entity.HasIndex(e => e.MaSanPham, "UQ__SAN_PHAM__FAC7442CDCBBCE3C").IsUnique();
